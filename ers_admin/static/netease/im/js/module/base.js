...
YX.fn.openChatBox = function (account, scene) {
    ...
    if(scene=="p2p"){
        ...
        if (info.account == userUID) {
            ...
            this.$chatTitle.find('img').attr('src', "/static/netease/im/images/myPhone.png") 
        } else {
        ...
        if(info){
            if(info.avatar){
                ...
                this.$chatTitle.find('img').attr('src', "/static/netease/im/images/" + info.type + ".png") 
            }
            ...
            this.$chatTitle.find('img').attr('src', "/static/netease/im/images/normal.png") 
    ...
    switch(type){
        case "session":   
            ...
            if(scene==="p2p"){
                ...
                if(msg.target === userUID){
                    info.nick = "我的手机"
                    info.avatar = "/static/netease/im/images/myPhone.png"
                }else{
                ...
                if(teamInfo){
                    ...
                    if(teamInfo.avatar){
                        ...
                        info.avatar = "/static/netease/im/images/"+teamInfo.type+".png"
                    }
                }else{
                    info.nick = msg.target
                    info.avatar = "/static/netease/im/images/normal.png"
                }   
            }
        break
        case "friend":
        ...
        case "team":
            ...
            if(data.avatar){
                ...
                info.avatar = info.type==="normal"?"/static/netease/im/images/normal.png":"/static/netease/im/images/advanced.png"
            }
            info.crtSession = this.crtSession  
        break
    }
